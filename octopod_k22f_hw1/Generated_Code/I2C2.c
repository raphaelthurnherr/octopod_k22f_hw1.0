...
#define I2C2_HAS_RTOS  0 /* No RTOS present */
#define I2C2_YIELD     1 /* Yield is enabled in the component properties */
...
#define I2C2_DELAY_NS    1250   /* delay time in ns, as specified in the component properties */

static byte SlaveAddr;             /* destination slave address      */

#define SCL_SetDir(dir) SCL2_SetDir(dir)
#define SCL_ClrVal()    SCL2_ClrVal()
#define SCL_GetVal()    SCL2_GetVal()

#define SDA_SetDir(dir) SDA2_SetDir(dir)
#define SDA_ClrVal()    SDA2_ClrVal()
#define SDA_GetVal()    SDA2_GetVal()
