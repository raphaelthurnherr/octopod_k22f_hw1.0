...
/* ----------------------------------------------------------------------------
  ...
  #error LLWU PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MKV40F15) /* LLWU */ && \
      !defined(MCU_MKV43F15) /* LLWU */ && \
      !defined(MCU_MKV44F15) /* LLWU */ && \
      !defined(MCU_MKV45F15) /* LLWU */ && \
      !defined(MCU_MKV46F15) /* LLWU */ && \
...
#if ((defined(MCU_MK65F18)) || (defined(MCU_MK65F18WS)) || (defined(MCU_MK66F18)) || (defined(MCU_MKV40F15)) || (defined(MCU_MKV43F15)) || (defined(MCU_MKV44F15)) || (defined(MCU_MKV45F15)) || (defined(MCU_MKV46F15)))
