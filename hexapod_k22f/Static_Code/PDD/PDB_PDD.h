...
/* ----------------------------------------------------------------------------
  ...
  #error PDB PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MKV40F15) /* PDB0, PDB1 */ && \
      !defined(MCU_MKV43F15) /* PDB0, PDB1 */ && \
      !defined(MCU_MKV44F15) /* PDB0, PDB1 */ && \
      !defined(MCU_MKV45F15) /* PDB0, PDB1 */ && \
      !defined(MCU_MKV46F15) /* PDB0, PDB1 */ && \
 ...
 * @remarks The macro accesses the following registers: PDB0_SC, PDB1_SC
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: PDB0_MOD, PDB1_MOD
 *          (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 * @remarks The macro accesses the following registers: PDB0_CNT, PDB1_CNT
 *          (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        value.
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: PDB0_IDLY, PDB1_IDLY
 *          (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        bits wide.
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: PDB0_POEN, PDB1_POEN
 *          (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          PDB0_PO0DLY, PDB1_PO0DLY (depending on the peripheral).
 * @par Example:
 *      @code
