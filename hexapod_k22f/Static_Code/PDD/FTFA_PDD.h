...
/* ----------------------------------------------------------------------------
  ...
  #error FTFA PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MKV40F15) /* FTFA */ && \
      !defined(MCU_MKV43F15) /* FTFA */ && \
      !defined(MCU_MKV44F15) /* FTFA */ && \
      !defined(MCU_MKV45F15) /* FTFA */ && \
      !defined(MCU_MKV46F15) /* FTFA */ && \
...
#elif ((defined(MCU_MK22F51212)) || (defined(MCU_MKL16Z4)) || (defined(MCU_MKL26Z4)) || (defined(MCU_MKL34Z4)) || (defined(MCU_MKL36Z4)) || (defined(MCU_MKL46Z4)) || (defined(MCU_MKV31F51212)))
/* SetFCCOBCommand constants */
  #define FTFA_PDD_READ_1S_BLOCK              0U   /**< Read 1s Block command value */
  #define FTFA_PDD_READ_1S_SECTION            0x1U /**< Read 1s Section command value */
  #define FTFA_PDD_PROGRAM_CHECK              0x2U /**< Program Check command value */
  #define FTFA_PDD_READ_RESOURCE              0x3U /**< Read Resource command value */
  #define FTFA_PDD_PROGRAM_LONGWORD           0x6U /**< Program Longword command value */
  #define FTFA_PDD_ERASE_FLASH_BLOCK          0x8U /**< Erase Flash Block command value */
  #define FTFA_PDD_ERASE_FLASH_SECTOR         0x9U /**< Erase Flash Sector command value */
  #define FTFA_PDD_READ_1S_ALL_BLOCKS         0x40U /**< Read 1s All Blocks command value */
  #define FTFA_PDD_PDD_READ_ONCE              0x41U /**< Read Once command value */
  #define FTFA_PDD_PROGRAM_ONCE               0x43U /**< Program Once command value */
...
#else /* (defined(MCU_MK22F12810)) || (defined(MCU_MK22F25612)) || (defined(MCU_MK24F25612)) || (defined(MCU_MKL02Z4)) || (defined(MCU_MKL03Z4)) || (defined(MCU_MKL04Z4)) || (defined(MCU_MKL05Z4)) || (defined(MCU_MKL14Z4)) || (defined(MCU_MKL15Z4)) || (defined(MCU_MKL24Z4)) || (defined(MCU_MKL25Z4)) || (defined(MCU_MKV31F12810)) || (defined(MCU_MKV31F25612)) || (defined(MCU_MKV40F15)) || (defined(MCU_MKV43F15)) || (defined(MCU_MKV44F15)) || (defined(MCU_MKV45F15)) || (defined(MCU_MKV46F15)) */
/* SetFCCOBCommand constants */
  #define FTFA_PDD_READ_1S_SECTION            0x1U /**< Read 1s Section command value */
  #define FTFA_PDD_PROGRAM_CHECK              0x2U /**< Program Check command value */
  #define FTFA_PDD_READ_RESOURCE              0x3U /**< Read Resource command value */
...
#endif /* (defined(MCU_MK22F12810)) || (defined(MCU_MK22F25612)) || (defined(MCU_MK24F25612)) || (defined(MCU_MKL02Z4)) || (defined(MCU_MKL03Z4)) || (defined(MCU_MKL04Z4)) || (defined(MCU_MKL05Z4)) || (defined(MCU_MKL14Z4)) || (defined(MCU_MKL15Z4)) || (defined(MCU_MKL24Z4)) || (defined(MCU_MKL25Z4)) || (defined(MCU_MKV31F12810)) || (defined(MCU_MKV31F25612)) || (defined(MCU_MKV40F15)) || (defined(MCU_MKV43F15)) || (defined(MCU_MKV44F15)) || (defined(MCU_MKV45F15)) || (defined(MCU_MKV46F15)) */
 ...
 * @par Example:
 *      @code
 *      FTFA_PDD_Cmd_Read1sBlock_Init(<peripheral>_BASE_PTR, 1,
 *      FTFA_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFA_PDD_Cmd_Read1sBlock_Init(PeripheralBase, Address, MarginLevel) ( \
    *(uint32_t*)&FTFA_FCCOB3_REG(PeripheralBase) = (Address) | (FTFA_PDD_READ_1S_BLOCK << 24), \
    (FTFA_FCCOB4_REG(PeripheralBase) = \
     (uint8_t)(MarginLevel)) \
  )
 ...
 *      @code
 *      uint32_t result =
 *      FTFA_PDD_Cmd_Read1sBlock_GetAddress(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFA_PDD_Cmd_Read1sBlock_GetAddress(PeripheralBase) ( \
    (uint32_t)((*(uint32_t *)(void *)&(FTFA_FCCOB3_REG(PeripheralBase))) & 0xFFFFFF) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFA_PDD_Cmd_Read1sBlock_SetAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFA_PDD_Cmd_Read1sBlock_SetAddress(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFA_FCCOB3_REG(PeripheralBase) = (Address) | (FTFA_PDD_READ_1S_BLOCK << 24) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFA_PDD_Cmd_Read1sBlock_GetMarginLevel(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFA_PDD_Cmd_Read1sBlock_GetMarginLevel(PeripheralBase) ( \
    (FTFA_FCCOB4_REG(PeripheralBase)) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFA_PDD_Cmd_Read1sBlock_SetMarginLevel(<peripheral>_BASE_PTR,
 *      FTFA_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFA_PDD_Cmd_Read1sBlock_SetMarginLevel(PeripheralBase, MarginLevel) ( \
    FTFA_FCCOB4_REG(PeripheralBase) = \
     (uint8_t)(MarginLevel) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFA_PDD_Cmd_EraseFlashBlock_Init(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFA_PDD_Cmd_EraseFlashBlock_Init(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFA_FCCOB3_REG(PeripheralBase) = (Address) | (FTFA_PDD_ERASE_FLASH_BLOCK << 24) \
  )
 ...
 *      @code
 *      uint32_t result =
 *      FTFA_PDD_Cmd_EraseFlashBlock_GetAddress(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFA_PDD_Cmd_EraseFlashBlock_GetAddress(PeripheralBase) ( \
    (uint32_t)((*(uint32_t *)(void *)&(FTFA_FCCOB3_REG(PeripheralBase))) & 0xFFFFFF) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFA_PDD_Cmd_EraseFlashBlock_SetAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFA_PDD_Cmd_EraseFlashBlock_SetAddress(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFA_FCCOB3_REG(PeripheralBase) = (Address) | (FTFA_PDD_PROGRAM_LONGWORD << 24) \
  )
