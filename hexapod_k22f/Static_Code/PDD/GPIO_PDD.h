...
/* ----------------------------------------------------------------------------
  ...
  #error GPIO PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MKV40F15) /* GPIOA, GPIOB, GPIOC, GPIOD, GPIOE */ && \
      !defined(MCU_MKV43F15) /* GPIOA, GPIOB, GPIOC, GPIOD, GPIOE */ && \
      !defined(MCU_MKV44F15) /* GPIOA, GPIOB, GPIOC, GPIOD, GPIOE */ && \
      !defined(MCU_MKV45F15) /* GPIOA, GPIOB, GPIOC, GPIOD, GPIOE */ && \
      !defined(MCU_MKV46F15) /* GPIOA, GPIOB, GPIOC, GPIOD, GPIOE */ && \
