...
/* ----------------------------------------------------------------------------
  ...
  #error LPUART PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MKL13Z4) /* LPUART0, LPUART1 */ && \
      !defined(MCU_MKL23Z4) /* LPUART0, LPUART1 */ && \
      !defined(MCU_MKL33Z4) /* LPUART0, LPUART1 */ && \
      !defined(MCU_MKL43Z4) /* LPUART0, LPUART1 */ && \
 ...
 *          LPUART1_BAUD (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          LPUART0_BAUD, LPUART1_CTRL, LPUART1_BAUD (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: LPUART0_CTRL,
 *          LPUART1_CTRL (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          LPUART1_DATA (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          LPUART1_MATCH (depending on the peripheral).
 * @par Example:
 *      @code
 *      uint16_t result =
 ...
 *          LPUART1_STAT (depending on the peripheral).
 * @par Example:
 *      @code
