...
/* ----------------------------------------------------------------------------
  ...
  #error PORT PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MKV40F15) /* PORTA, PORTB, PORTC, PORTD, PORTE */ && \
      !defined(MCU_MKV43F15) /* PORTA, PORTB, PORTC, PORTD, PORTE */ && \
      !defined(MCU_MKV44F15) /* PORTA, PORTB, PORTC, PORTD, PORTE */ && \
      !defined(MCU_MKV45F15) /* PORTA, PORTB, PORTC, PORTD, PORTE */ && \
      !defined(MCU_MKV46F15) /* PORTA, PORTB, PORTC, PORTD, PORTE */ && \
