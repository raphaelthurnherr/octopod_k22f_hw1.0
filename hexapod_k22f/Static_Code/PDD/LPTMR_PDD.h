...
/* ----------------------------------------------------------------------------
  ...
  #error LPTMR PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MKV40F15) /* LPTMR */ && \
      !defined(MCU_MKV43F15) /* LPTMR */ && \
      !defined(MCU_MKV44F15) /* LPTMR */ && \
      !defined(MCU_MKV45F15) /* LPTMR */ && \
      !defined(MCU_MKV46F15) /* LPTMR */ && \
 ...
 * @remarks The macro accesses the following registers: LPTMR0_CSR, LPTMR_CSR
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: LPTMR0_PSR, LPTMR_PSR
 *          (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        value.
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: LPTMR0_CMR, LPTMR_CMR
 *          (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        (<component_name>_DEVICE).
 * @return Returns a 32-bit value.
 * @remarks The macro accesses the following registers: LPTMR0_CNR, LPTMR_CNR
 *          (depending on the peripheral).
 * @par Example:
 *      @code
